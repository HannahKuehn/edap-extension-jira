  ...
  groups: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          short: ["biased behaviour can lead to illegal discriminatory practices", "convene with people from different perspectives and backgrounds within your team"],
        ...
        },
        {
          ...
          short: ["check for conditions or aggreements covering data sharing"],
        ...
        },
        {
          ...
          short: ["consider individuals rights over their data", "consider how they would feel about the use of their data"],
          ...
          subquestions: [
            ...
            },
            {
              ...
              short: ["communicate what you want to do with the data", "communicate risks and harms", "make communication accessible"],
        ...
        },
        {
          ...
          short: ["consider legal requirements", "consider broader social outcomes"],
